    ...
    <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 bg-primary-50/30">
      <div className="max-w-7xl mx-auto">
        <SectionHeading
          ...
          subtitle="Como ortodoncista en Valencia, ofrezco una gama completa de tratamientos adaptados a las necesidades de cada paciente: desde ortodoncia infantil e invisible con alineadores hasta brackets de autoligado."
        />
